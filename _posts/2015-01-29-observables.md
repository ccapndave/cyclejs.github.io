...
>
> Besides from containing RxJS, Cycle *Core* delivers only the `run()` function which is implemented with about 100 lines of code. This means it's a very small library.
>
> In TodoMVC built with Cycle.js these are the proportions each library or section takes:
>
> - RxJS: 71,1 %
> - virtual-dom: 9,76 %
> - @cycle/web: 4,87 %
